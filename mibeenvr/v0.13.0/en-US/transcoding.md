...
Transcoding metrics are exposed at `/api/metrics` (the full list with labels and types is in [metrics.md](observability.md#11-transcoding-metrics)):
...
For more detailed troubleshooting, check the [Configuration](config.md) and [API Reference](api.md) documents.