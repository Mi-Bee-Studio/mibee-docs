...
**ONVIF 集成**：有关全面的 ONVIF 摄像头支持、发现方法、PTZ 控制和故障排除，请参阅 [ONVIF 指南](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/zh/onvif-guide.md)。
...
- [MiBee NVR 配置指南](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/zh/configuration.md)
- [MiBee NVR API 参考](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/zh/api/README.md)
- [MiBee NVR 入门指南](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/zh/getting-started.md)
...
详细架构设计请参见[架构文档](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/zh/architecture.md)。
