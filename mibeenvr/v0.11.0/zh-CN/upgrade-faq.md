...
- **基于 `pkg/` 扩展接口构建自己的程序**：受[链接例外](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/9f940324bfc733e9a6240868f48c68c38c21a78f/LICENSE.pkg-linking-exception)保护，你的程序许可证由你决定。
- **独立进程通过 HTTP/WebSocket API 调用运行中的 NVR**：完全不受许可证影响。

详见 [LICENSE](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/9f940324bfc733e9a6240868f48c68c38c21a78f/LICENSE)、[NOTICE](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/9f940324bfc733e9a6240868f48c68c38c21a78f/NOTICE) 与 [CONTRIBUTING.md](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/9f940324bfc733e9a6240868f48c68c38c21a78f/CONTRIBUTING.md)。
