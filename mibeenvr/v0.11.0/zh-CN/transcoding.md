...
转码指标在 `/api/metrics` 暴露（带标签和类型的完整列表见 [metrics.md](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/9f940324bfc733e9a6240868f48c68c38c21a78f/docs/zh/metrics.md#11-transcoding-metrics)）：
...
更多详细的故障排除，请查看 [配置](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/9f940324bfc733e9a6240868f48c68c38c21a78f/docs/zh/configuration.md) 和 [API 参考](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/9f940324bfc733e9a6240868f48c68c38c21a78f/docs/zh/api/README.md) 文档。