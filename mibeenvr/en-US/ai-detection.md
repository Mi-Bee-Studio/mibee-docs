...
See known-issues-ai-logit-false-positives.md.
...
- Known issue: logit explosion causing wall-to-wall person:100% false positives
- Known issue: ONNX model loading gzip-trailer
