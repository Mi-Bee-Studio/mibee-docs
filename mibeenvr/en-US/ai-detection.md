...
See [known-issues-ai-logit-false-positives.md](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/known-issues-ai-logit-false-positives.md).
...
- [Known issue: logit explosion causing wall-to-wall person:100% false positives](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/known-issues-ai-logit-false-positives.md)
- [Known issue: ONNX model loading gzip-trailer](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/known-issues-ai-onnx-gzip-trailer.md)
