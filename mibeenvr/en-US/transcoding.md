...
Transcoding metrics are exposed at `/api/metrics` (the full list with labels and types is in [metrics.md](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/en/metrics.md#11-transcoding-metrics)):
...
For more detailed troubleshooting, check the [Configuration](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/en/configuration.md) and [API Reference](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/en/api/README.md) documents.