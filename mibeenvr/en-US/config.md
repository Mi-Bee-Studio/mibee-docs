...
> `mibee-nvr encrypt-config` encrypts plaintext secrets in place (see the [CLI reference](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/en/cli.md#encrypt-config-encrypt-sensitive-fields)).
