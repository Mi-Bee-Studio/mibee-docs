...
- **Building your own program on the `pkg/` extension interfaces**: covered by a [linking exception](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/LICENSE.pkg-linking-exception) — your program's license stays your choice.
- **A separate program talking to a running NVR** over its HTTP/WebSocket APIs: never affected by the license.

See [LICENSE](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/LICENSE), [NOTICE](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/NOTICE), and [CONTRIBUTING.md](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/CONTRIBUTING.md) for details.
