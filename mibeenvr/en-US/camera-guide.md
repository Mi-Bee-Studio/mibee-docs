...
**ONVIF Integration**: For comprehensive ONVIF camera support, discovery methods, PTZ control, and troubleshooting, see the [ONVIF Guide](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/en/onvif-guide.md).
...
- [MiBee NVR Configuration Guide](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/en/configuration.md)
- [MiBee NVR API Reference](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/en/api/README.md)
- [MiBee NVR Getting Started](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/en/getting-started.md)
