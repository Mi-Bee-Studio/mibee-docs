...
> `frame_watchdog_timeout` and `health_overrides` (see [configuration.md](https://github.com/Mi-Bee-Studio/MiBeeNvr/blob/v0.13.0/docs/en/configuration.md)).
