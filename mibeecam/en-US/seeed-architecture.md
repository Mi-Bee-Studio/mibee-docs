...
The MJPEG streamer runs on **port 81** as an independent TCP server, completely separate from the main httpd on port 80. See [Port Separation Design](seeed-port-separation-design.md) for details.
