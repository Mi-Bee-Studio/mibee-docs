...
> [← Device Control](seeed-api-control.md) | [WiFi Scan →](seeed-api-wifi.md)
...
> [← MJPEG Stream](#get-stream--mjpeg-real-time-video-stream) | [Device Control →](seeed-api-control.md)
