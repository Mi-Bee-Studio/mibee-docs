...
> [← Status Query](seeed-api-status.md) | [File Management →](seeed-api-files.md)
...
The device management involves three password fields, with different behavior in GET and POST:
