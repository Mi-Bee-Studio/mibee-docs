...
> [← File Management](seeed-api-files.md) | [Video Stream →](seeed-api-stream.md)
...
**Authentication**: None — contract v1.9 (2026-09-18) removed the device-level web password
...
> After reboot, device will start with default configuration (default AP mode).
