...
See [LICENSE](https://github.com/Mi-Bee-Studio/mibee-fingerprints-go/blob/main/LICENSE) for the AGPLv3 full text and [NOTICE](https://github.com/Mi-Bee-Studio/mibee-fingerprints-go/blob/main/NOTICE) for
